                ...
                <div class="mt-5">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="grid gap-y-4">
                            ...
                            <!-- Form Group -->
                            <div>
                                <label for="confirm-password" class="block mb-2 text-sm dark:text-white">Ulangi Password</label>
                                <div class="relative">
                    ...
                    <div class="flex items-center py-3 text-xs text-gray-400 before:me-6 before:flex-1 before:border-t before:border-gray-200 after:ms-6 after:flex-1 after:border-t after:border-gray-200 dark:text-neutral-500 dark:before:border-neutral-600 dark:after:border-neutral-600">
                        atau
                    </div>
