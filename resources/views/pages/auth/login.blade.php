                ...
                <div class="mt-5">
                    ...
                    <form>
                        <div class="grid gap-y-4">
                            ...
                            <button type="submit"
                                class="inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-4 py-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-50">Masuk</button>
                        </div>
                    </form>
                    <!-- End Form -->
