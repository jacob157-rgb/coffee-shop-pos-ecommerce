        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'dashboard')&& (page === 'dashboard.index') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'category') && (page === 'category.index') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'product') && (page === 'product.index') }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'user') && (page === 'user.index') }"
            >
              <svg
                class="fill-current"
                width="18"
